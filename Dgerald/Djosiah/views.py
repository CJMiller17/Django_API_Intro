...
class StudentViewSet(viewsets.ModelViewSet): #This is the end point
    queryset = Student.objects.all()
    serializer_class = StudentSerializer

class InstructorViewSet(viewsets.ModelViewSet): #This is the end point
...
class CourseViewSet(viewsets.ModelViewSet): #This is the end point
